...
const HomePage = () => {
    ...
    <div>
      ...
      <main>
        <section className="flex flex-col lg:flex-row items-center bg-[url('https://images.unsplash.com/photo-1546984575-757f4f7c13cf?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center  lg:h-[644px] ">
          ...
          <div className=' bg-black50 text-center p-10 rounded-[30px] m-2 mb-7 mt-14 md:flex md:flex-col md:mx-10 lg:w-1/2 '>
  <h1 className='mb-4 text-[24px] whitespace-nowrap w-full'>
    <span className='text-white mr-4'>Welcome to</span>
    <span className='text-blueproject'>Project Manager</span>
  </h1>
  <p className='mb-4 w-full md:text-justify'>
  ...
  <button className='border border-white rounded-[30px] px-10 py-1 md:self-start'>
    Get Started
  </button>
</div>
          {/* Imagem */}
          ...
          <div className="flex flex-col md:flex-row items-center md:justify-center space-y-4 md:space-y-0 md:space-x-5 gap-5 lg:flex-col">
            <div className="bg-customPurple text-white rounded-[15px] px-7 py-4 shadow-md ">
              <p>2000+</p>
              <p>Satisfied clients</p>
            </div>
            <div className="bg-customPurple text-white rounded-[15px] px-6 py-3 shadow-md ">
              <p>400+</p>
    ...
    <section className='bg-darkGray text-white lg:relative'>
      <div className='flex flex-col items-center p-5'>
      <div className='text-center md:text-left md:items-start'>
      <h2 className='text-themanagercolor mb-4 text-left'>The Manager</h2>
      ...
      <button className='text-darkBlue bg-white rounded px-3 py-3 md:self-start md:text-left'>Learn More</button>
    </div>
  </div>
  ...
  <ul className='flex space-x-8 overflow-x-auto p-5'>
    ...
    <section className="flex flex-col items-center text-center bg-bgTools text-white pb-[59px]">
      <div className="m-12 space-y-6">
        <h2 className="text-2xl font-bold text-themanagercolor">Featured Tools</h2>
        <p className="mb-4">Tools to enhance your project management</p>
        <button className="px-3 py-3 bg-white rounded-md text-darkBlue">View All</button>
      </div>
    <div>
  ...
  <section className="flex flex-col items-center bg-white2 text-darkBlue">
  ...
  <form className="w-80 h-80 p-4 bg-white rounded-lg shadow-md flex flex-col justify-between items-center">
    <div className="w-full mb-4">
      ...
      <input
        ...
        className="p-2 w-full rounded-md border-2 border-black50"
      />
      <p className=" mb-4 text-black50">We promise not to spam</p>
    </div>
    ...
    <button className="w-full p-2 bg-darkGray text-white rounded-md">Subscribe</button>
    </form>
  </section>
  </main>
