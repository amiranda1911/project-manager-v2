...
const KanbanColumn = ({type, tasks} : KanbanColumnProps) => {
  ...
  return (
    <div className={`
			...
			`}>
				<header className="	column-header flex items-center content-between w-full h-4 md:h-[1.86rem] lg:h-[2.81rem] rounded-full p-2 box-border">
