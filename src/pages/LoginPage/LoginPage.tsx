    ...
    <>
      ...
      <main className=" min-h-[49rem] lg:h-[39.063rem]">
        <div className=" min-h-screen lg:flex ">
          {/* Background image */}
          <div
            className="relative bg-cover bg-center h-screen min-h-[49rem] lg:w-[39.125rem] lg:h-[39.063rem] lg:order-2"
            style={{ backgroundImage: `url('LoginImg.svg')` }}
          ></div>

          {/* Translucent background */}
          <div className="absolute inset-0 bg-white opacity-70 h-screen min-h-[49.5rem] md:min-h-[50.2rem] mt-16 lg:hidden"></div>
