    ...
    <div className="p-5 sm:leading-8 sm:text-sm md:leading-9 md:text-base lg:p-24">
        <div className="my-5">
            <div className="flex items-center mb-9 w-full">
                <picture className="flex mr-4 md:mr-8">
                    <img src={img} alt="Imagem de perfil" className="w-29 h-30 min-w-29 rounded-full shadow-md md:w-45 md:h-46" /> {/*shadow arrumar*/}
                </picture>
                <div>
                    <h1 className="text-21 font-medium md:text-5xl">John Doe</h1>
                    <p className="text-xl opacity-70 md:text-19">john.doe@example.com</p>
                </div>
            </div>
            <div>
                <h2 className="text-20 font-medium">Project profile</h2>
                <p className="text-black-opacity-50">Update your profile information in the sections below.</p>
            </div>
        </div>
        ...
        <div className="flex flex-col justify-between lg:flex-row">
            <div className="w-1/4 min-w-96">
                ...
                <p className="text-black-opacity-50">Update your profile picture. Supported files are JPG, PNG, WebP and JPEG.</p>
            </div>
            ...
            <div className="flex flex-wrap my-6 text-gray-850 text-12 lg:mx-11 lg:w-3/6">
                ...
                <div>
                    <label htmlFor="new-team-members" className="flex">
                        <input type="radio" id="new-team-members" name="notifications-update" className="mr-2" /> 
                ...
                <div>
                    <label htmlFor="weekly-reports" className="flex">
                        <input type="radio" id="weekly-reports" name="notifications-update" className="mr-2" />
                        <p>Weekly reports</p>
                    </label>
